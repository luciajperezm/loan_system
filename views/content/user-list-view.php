...
<div class="buttons">
    ...
    <button class="btn btn__cta active"><i class="fas fa-list ic"></i><a href="<?php echo SERVER_URL;?>user-list/">List of Users</a></button>
...
<?php require_once "./controllers/userController.php";
      ...
      echo $ins_user->pagination_user_controller($page[1], 15, $_SESSION['privilege_loan'],$_SESSION['id_loan'],$page[0], "");