...
<div class="buttons">
    ...
    <button class="btn btn__cta"><i class="fas fa-list ic"></i><a href="<?php echo SERVER_URL;?>reservation-list
    /">Payed Loans</a></button>
    <button class="btn btn__cta"><i class="fas fa-search ic"></i><a href="<?php echo SERVER_URL;?>reservation-search
    /">Search Loans</a></button>
</div>
<table class="table table-sm">
    ...
    <tr>
        ...
        <td class="text-center ">2017/10/8</td>
        <td class="text-center "><span class="badge badge-info">Reservacion</span></td>
        <td class="text-center "><span class="badge badge-primary">Pendiente</span></td>
