<h2>New Product</h2>
<p>Here you can add Products to the system. This information is required if you want to make a transaction. Make sure the information you introduce is correct.</p>
<div class="buttons">
  <button class="btn btn__cta active"><i class="fas fa-plus ic"></i><a href="<?php echo SERVER_URL;?>product-new/">New Product</a></button>
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        ...
                        <input type="number" pattern="[0-9]{1,9}" class="form-control" name="product_stock_reg" id="product_stock" maxlength="9">
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="form-group">
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <input type="text" pattern="[a-zA-Z0-9- ]{1,45}" class="form-control" name="product_detail_reg" id="product_detail" maxlength="45"></div>
                  </div>
              </div>
        </div>
    </fieldset>
