...
<div class="modal fade" id="ModalAddProduct" tabindex="-1" role="dialog" aria-labelledby="ModalAddProduct"
    ...
    <div class="modal-dialog" role="document">
        <form class="modal-content FormularioAjax">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalAddProduct">Selecciona el formato, cantidad de items, tiempo y costo
                    del
                    préstamo del item</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="detail_format" class="bmd-label-floating">Formato de préstamo</label>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="detail_quantity" class="bmd-label-floating">Cantidad de items</label>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="detail_time" class="bmd-label-floating">Tiempo (según formato)</label>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="detail_cost_time" class="bmd-label-floating">Costo por unidad de
                                    tiempo</label>
