<h2>New Lease</h2>
<p>Here you can add Leases to the system, make sure the information you introduce is correct.</p>
<div class="buttons">
    <button class="btn btn__cta active"><i class="fas fa-plus ic"></i><a href="<?php echo SERVER_URL;?>reservation-new/">New Lease</a></button>
...
<p class="text-center">
    ...
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalCustomer"><i class="fas fa-user-plus"></i> &nbsp; Add a customer</button>
    <?php  } ?>
    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalItem"><i class="fas fa-box-open"></i> &nbsp; Add Products</button>
</p>
<div>
...
<table class="table table-sm">
    ...
    <tr>
        ...
        <td class="text-center ">
            <form class="form-table Ajax_Form" action="<?php echo SERVER_URL;?>ajax/loanAjax.php" method="post" data-form="loans" autocomplete="off">
...
<form class="Ajax_Form" action="<?php echo SERVER_URL; ?>ajax/loanAjax.php" method="POST" data-form="save" autocomplete="off">
    <fieldset>
            ...
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="loan_date_init">Date</label>
                        <input type="date" class="form-control" value="<?php echo date("Y-m-d"); ?>" name="loan_date_init_reg" id="loan_date_init">
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="loan_time_init">Time</label>
                        <input type="time" class="form-control" value="<?php echo date("H:i"); ?>" name="loan_time_init_reg" id="loan_time_init">
                    </div>
                </div>
            </div>
        </div>
    ...
    <fieldset>
        <legend><i class="fas fa-history"></i> &nbsp; Date and time of return</legend>
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="loan_date_final">Return Date</label>
                        <input type="date" class="form-control" name="loan_date_final_reg" id="loan_date_final">
                    </div>
                </div>
                <div class="col-12 col-md-6">
                    <div class="form-group">
                        <label for="loan_time_final">Return Time</label>
                ...
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="loan_status_reg" id="loan_status">
                            ...
                            <option value="Loan">Active Lease</option>
                            <option value="Finished">Payed Lease</option>
                        </select>
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" pattern="[0-9.]{1,10}" class="form-control" readonly="" value="<?php echo CURRENCY.number_format($_SESSION['loan_total'], 2, '.', ''); ?>" id="loan_total" maxlength="10">
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        <label for="loan_payed" class="bmd-label-floating">Total payed (<?php echo CURRENCY;?>)</label>
                        <input type="text" pattern="[0-9.]{1,10}" class="form-control" name="loan_payed_reg" id="loan_payed" maxlength="10">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label for="loan_observation" class="bmd-label-floating">Observation</label>
                        <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ#() ]{1,400}" class="form-control" name="loan_observation_reg" id="loan_observation" maxlength="400">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="form-group">
                        <label for="input_customer" class="bmd-label-floating">ID, Name, Last name</label>
                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" class="form-control" name="input_customer" id="input_customer" maxlength="30">
                    </div>
                </div>
                <br>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" onclick="search_customer()"><i class="fas fa-search fa-fw"></i> &nbsp;
                  Search</button>
                &nbsp; &nbsp;
...
<div class="modal fade" id="ModalAddProduct" tabindex="-1" role="dialog" aria-labelledby="ModalAddProduct" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form class="modal-content Ajax_Form" action="<?php echo SERVER_URL;?>ajax/loanAjax.php" method="post" data-form="default" autocomplete="off">
            <div class="modal-header">
                <h5 class="modal-title" id="ModalAddProduct">Choose a format, quantity of items, cost of time per item</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-12">
                            <div class="form-group">
                                <label for="detail_format" class="bmd-label-floating">Lease Format</label>
                        ...
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                ...
                                <input type="number" pattern="[0-9]{1,7}" class="form-control" name="detail_quantity" id="detail_quantity" maxlength="7" required="">
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="detail_time" class="bmd-label-floating">Time (according to format)</label>
                                <input type="number" pattern="[0-9]{1,7}" class="form-control" name="detail_time" id="detail_time" maxlength="7" required="">
                            </div>
                        </div>
                        <div class="col-12 col-md-4">
                            <div class="form-group">
                                <label for="detail_cost_time" class="bmd-label-floating">Cost per time unit</label>
                                <input type="text" pattern="[0-9.]{1,15}" class="form-control" name="detail_cost_time" id="detail_cost_time" maxlength="15" required="">
                            </div>
                        </div>
                    </div>
                </div>
