...
<div class="buttons">
  <button class="btn btn__cta active"><i class="fas fa-plus ic"></i><a href="<?php echo SERVER_URL;?>customer-new/">New Customer</a></button>
...
<form class="Ajax_Form form-neon box" action="<?php echo SERVER_URL;?>ajax/customerAjax.php" method="post" data-form="save" autocomplete="off">
    <fieldset>
            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" pattern="[0-9-]{1,20}" class="form-control" name="customer_dni_reg" id="customer_dni" maxlength="20">
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        <label for="customer_name" class="bmd-label-floating">First Name:</label>
                        <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="customer_name_reg" id="customer_name" maxlength="40">
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        <label for="customer_lastname" class="bmd-label-floating">Last Name:</label>
                        <input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="customer_lastname_reg" id="customer_lastname" maxlength="40">
                    </div>
                </div>
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        <label for="customer_phone" class="bmd-label-floating">Phone:</label>
                        <input type="text" pattern="[0-9+-]{1,15}" class="form-control" name="customer_phone_reg" id="customer_phone" maxlength="15">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group">
                        <label for="customer_address" class="bmd-label-floating">Address:</label>
                        <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,150}" class="form-control" name="customer_address_reg" id="customer_address" maxlength="150">
                    </div>
                </div>
            </div>
        </div>
