...
<p>Here you can update registered customers. Make sure the information you introduce is correct. </p>
<div class="buttons">
...
?>
<form class="Ajax_Form form-neon box" action="<?php echo SERVER_URL;?>ajax/customerAjax.php" method="post" data-form="update" autocomplete="off">
            ...
            <div class="row">
                <div class="col-12 col-md-3">
                    <div class="form-group">
                        ...
                        <input type="text" pattern="[0-9-]{1,20}" class="form-control" name="customer_dni_up" id="customer_dni" maxlength="20" value="<?php echo $fields['cliente_dni']; ?>">
                    </div>
                </div>
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            <label for="customer_name" class="bmd-label-floating">First Name</label>
                            <input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control" name="customer_name_up" id="customer_name" maxlength="45" value="<?php echo $fields['cliente_nombre']; ?>">
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            <label for="customer_last_name" class="bmd-label-floating">Last Name</label>
                            <input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control" name="customer_last_name_up" id="customer_last_name" maxlength="45" value="<?php echo $fields['cliente_apellido']; ?>">
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="form-group">
                            <label for="customer_phone" class="bmd-label-floating">Phone</label>
                            <input type="text" pattern="[0-9+-]{1,15}" class="form-control" name="customer_phone_up" id="customer_phone" maxlength="20" value="<?php echo $fields['cliente_telefono']; ?>">
                        </div>
                    </div>
                    <div class="col-12 ">
                        <div class="form-group">
                            <label for="customer_address" class="bmd-label-floating">Address</label>
                            <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,150}" class="form-control" name="customer_address_up" id="customer_address" maxlength="150" value="<?php echo $fields['cliente_direccion']; ?>">
                        </div>
                    </div>
            </div>
        </div>
...
<div class="alert alert-danger text-center" role="alert">
    ...
    <p class="mb-0">Sorry, we couldn't update tha customer information due to an error.</p>
</div>
<?php } ?>