...
<p>Here you can update the information of the registered Products. Make sure the information you introduce is correct.</p>
<div class="buttons">
...
?>
<form class="Ajax_Form form-neon box" action="<?php echo SERVER_URL;?>ajax/productAjax.php" method="post" data-form="update" autocomplete="off">
            ...
            <div class="row">
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <input type="text" pattern="[a-zA-Z0-9-]{1,45}" class="form-control" name="product_code_up" id="product_code" maxlength="45" value="<?php echo $fields['item_codigo'];?>">
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        <label for="product_name" class="bmd-label-floating">Name</label>
                        <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}" class="form-control" name="product_name_up" id="product_name" maxlength="140" value="<?php echo $fields['item_nombre']; ?>">
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        <label for="product_stock" class="bmd-label-floating">Stock</label>
                        <input type="number" pattern="[0-9]{1,9}" class="form-control" name="product_stock_up" id="product_stock" maxlength="9" value="<?php echo $fields['item_stock']; ?>">
                    </div>
                </div>
                <div class="col-12 col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="product_status_up" id="product_status">
                            <option value="Available" <?php if($fields['item_estado'] == "Available"){ echo'selected=""'; } ?>>Available</option>
                ...
                <div class="col-12 col-md-8">
                    <div class="form-group">
                        ...
                        <input type="text" pattern="[a-zA-záéíóúÁÉÍÓÚñÑ0-9 ]{1,140}" class="form-control" name="product_detail_up" id="product_detail" maxlength="9" value="<?php echo $fields['item_detalle']; ?>">
                    </div>
                </div>
            </div>
        </div>
