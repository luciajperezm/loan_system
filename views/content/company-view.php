<h2>Company</h2>
<p>Here you can introduce information about the company. This data will be used to generate receipts so make sure the information is correct.</p><br>
<?php
...
?>
    <form class="Ajax_Form form-neon box" action="<?php echo SERVER_URL;?>ajax/companyAjax.php" method="post" data-form="save" autocomplete="off">
        <fieldset>
...
<form class="Ajax_Form form-neon box" action="<?php echo SERVER_URL;?>ajax/companyAjax.php" method="post"
      ...
      <div class="row">
          <div class="col-12 col-md-6">
              <div class="form-group">
                  <label for="company_name" class="bmd-label-floating">Company Name:</label>
                  <input type="text" pattern="[a-zA-z0-9áéíóúÁÉÍÓÚñÑ. ]{1,70}" class="form-control" name="company_name_up" id="company_name" maxlength="70" value="<?php echo $fields['empresa_nombre']; ?>">
              </div>
          </div>
          <div class="col-12 col-md-6">
              <div class="form-group">
                  <label for="company_email" class="bmd-label-floating">Email:</label>
                  <input type="email" class="form-control" name="company_email_up" id="company_email" maxlength="70" value="<?php echo $fields['empresa_email']; ?>">
              </div>
          </div>
              <div class="col-12 col-md-6">
                  <div class="form-group">
                      <label for="company_phone" class="bmd-label-floating">Phone:</label>
                      <input type="text" pattern="[0-9()+]{8,20}" class="form-control" name="company_phone_up" id="company_phone" maxlength="20" value="<?php echo $fields['empresa_telefono']; ?>">
                  </div>
              </div>
              <div class="col-12 col-md-6">
                  <div class="form-group">
                      <label for="company_address" class="bmd-label-floating">Address:</label>
                      <input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,#\- ]{1,190}" class="form-control" name="company_address_up" id="company_address" maxlength="190" value="<?php echo $fields['empresa_direccion']; ?>">
                  </div>
              </div>
            </div>
        </div>
